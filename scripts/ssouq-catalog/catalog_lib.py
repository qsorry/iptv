# -*- coding: utf-8 -*-
"""Shared cleaning helpers: category inference, MDI icon mapping, description -> bullet groups."""
...
ICON_RULES = [
 ...
 ('television-classic',r'قنوات|قناة|تلفزيون|بث|iptv|شاشات|\btv\b|live|webos|\blg\b|samsung|سامسونج|tizen'),
